...
const getStatusConfig = (status: ModernTimelineItem["status"]) => {
  const configs = {
    completed: {
...
const getStatusIcon = (status: ModernTimelineItem["status"]) => {
  switch (status) {
    case "completed":
      return CheckCircle;
    case "current":
...
export function ModernTimeline({ items, className }: ModernTimelineProps) {
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <motion.div
          className="absolute left-4 sm:left-6 -bottom-2 -translate-x-1/2"
