...
export function SocialProofBar() {
  return (
    <section className="border-b border-border">
      <div className="mx-auto max-w-5xl px-6 sm:px-8 py-4">
        <a
        ...
        >
          ...
          <span className="text-sm text-muted-foreground">
            11 Five-Star Reviews
          </span>
          <span className="text-sm text-muted-foreground/50 group-hover:text-primary transition-colors duration-200">
            &rarr;
          </span>
        </a>
      </div>
