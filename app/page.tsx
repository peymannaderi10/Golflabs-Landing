          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "No membership required. You can book and pay per session with no commitment. Optional memberships are available from $45/mo for monthly bay hours and priority booking.",
                },
              },
            ],
          }),
